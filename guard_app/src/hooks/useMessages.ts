...
import type { ConversationItemData } from '../components/list/ConversationItem';
import type { MessageItemData } from '../components/list/MessageItem';
import type { RootStackParamList } from '../navigation/AppNavigator';
import type { RouteProp } from '@react-navigation/native';

export type Message = MessageItemData & {
  context: 'shift' | 'general';
  shiftTitle?: string;
};

export type ConversationItem = ConversationItemData;

// GA-021 — all MessagesScreen state/effects/handlers, extracted from the screen
