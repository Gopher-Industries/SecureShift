                ...
                <Pressable style={s.modalContent} onPress={(e) => e.stopPropagation()}>
                    ...
                    <View style={s.modalBody}>
                        ...
                        <TouchableOpacity style={s.dropdown} onPress={() => setShowDropdown(!showDropdown)}>
                            <Text
                                style={
                                    requestType ? s.dropdownTextSelected : s.dropdownTextPlaceholder
                                }
                            >
                            ...
                            <View style={s.dropdownMenu}>
                                {REQUEST_TYPES.map((request) => (
                                    <TouchableOpacity
                                        ...
                                        style={[
                                            s.dropdownItem,
                                            requestType === request.id && s.dropdownItemSelected,
                                        ]}
                                        onPress={() => {
                        ...
                        {requestType === REQUEST_TYPES[0].label && (
                            <View>
                                ...
                                <TouchableOpacity style={s.modalTimeInput} onPress={() => openPicker('date')}>
                                    <Text style={s.modalTimeText}>{requestDate ? requestDate.toDateString() : t("shifts.selectDate")}</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={s.modalTimeInput} onPress={() => openPicker('time')}>
                                    <Text style={s.modalTimeText}>{requestTime ? formatTime(requestTime) : t("shifts.selectTime")}</Text>
                                </TouchableOpacity>
                                </View>
                            </View>
                        )}
