...
export default function NotificationsPopup() {
        ...
        try {
            ...
            shifts.forEach((shift) => {
                ...
                applicants.forEach((applicant) => {
                    ...
                    if (!prevIds.includes(applicantId)) {
                        newNotifications.push({
                            id: `${shift._id}-${applicantId}`,
                            shiftId: shift._id,
            ...
            console.error("Failed to fetch shifts for notifications:", error);
        }
    };

    useEffect(() => {
        fetchAndDiffShifts();
        const interval = setInterval(fetchAndDiffShifts, 30000);
    ...
    return (
        <div ref={popupRef} style={{ position: "relative", display: "flex", alignItems: "center" }}>
            ...
            {/* Bell icon */}
            <div onClick={handleBellClick} style={{ cursor: "pointer", display: "flex", alignItems: "center" }}>
