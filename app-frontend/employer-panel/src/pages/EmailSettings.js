...
export default function EmailSettings() {
  ...
  const loadSettings = async () => {
    ...
    try {
      ...
      const passwordValue =
        data.SMTP_PASS === '***hidden***' || !data.SMTP_PASS ? '' : data.SMTP_PASS;
      reset({
      ...
      >
        ...
        <div style={{ fontSize: '14px', lineHeight: '1.8' }}>
          ...
          <ul style={{ marginLeft: '20px' }}>
            <li>
              Host: <code>smtp.gmail.com</code>
            </li>
            <li>
              Port: <code>587</code>
            </li>
            <li>
              Secure: <code>false</code>
            </li>
          ...
          <ul style={{ marginLeft: '20px' }}>
            <li>
              Host: <code>smtp.sendgrid.net</code>
            </li>
            <li>
              Port: <code>587</code>
            </li>
            ...
            <li>
              <strong>From Email:</strong> Must be a verified sender in SendGrid (verify in SendGrid
              dashboard)
            </li>
          </ul>
          ...
          <ul style={{ marginLeft: '20px', color: '#d32f2f' }}>
            <li>
              <strong>SendGrid:</strong> Go to Settings → Sender Authentication → Verify a Single
              Sender
            </li>
            <li>
              <strong>Gmail:</strong> Use your Gmail address (already verified)
            </li>
          </ul>
        </div>
      </div>
