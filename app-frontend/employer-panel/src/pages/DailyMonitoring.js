...
const guards = [
    ...
    checkpoints: [
      {
        ...
        site: 'Chadstone',
        time: '11:55:02',
        note: 'Second pass – all secure',
      },
      {
        name: 'Parking Lot',
        site: 'Chadstone',
        time: '12:00:00',
        note: 'Vehicle parked in restricted zone — license plate noted, security cone placed.',
        issue: true,
      },
      {
        name: 'Main Entrance',
  ...
  },
  {
    ...
    date: '22-04-2026',
    payRate: '42/hr',
    activities: [{ type: 'clockin', label: 'Clocked In', time: '09:00:00' }],
    checkpoints: [
    ...
    activities: [
      {
        ...
        label: 'Absent',
        time: '08:30:00',
        note: 'Did not report for scheduled shift',
      },
    ],
    checkpoints: [],
  },
    ...
    activities: [
      {
        ...
        label: 'Late Arrival',
        time: '09:45:00',
        note: 'Arrived 45 min late — traffic delay',
      },
    ...
    checkpoints: [
      {
        ...
        site: 'Marvel Stadium',
        time: '09:00:00',
        note: 'Crowd control check – all good',
      },
      {
        name: 'VIP Entrance',
        site: 'Marvel Stadium',
        time: '11:30:00',
        note: 'Unauthorised individual attempted entry — escorted off premises.',
        issue: true,
      },
    ],
  },
  {
    ...
    date: '22-04-2026',
    payRate: '41/hr',
    activities: [{ type: 'clockin', label: 'Clocked In', time: '08:30:00' }],
    checkpoints: [
    ...
    activities: [
      {
        ...
        label: 'Late Arrival',
        time: '10:15:00',
        note: 'Arrived 75 min late — car trouble',
      },
    ...
    checkpoints: [
      {
        ...
        site: 'Burwood One',
        time: '07:00:00',
        note: 'Morning inspection complete',
      },
  ...
  },
  {
    ...
    date: '22-04-2026',
    payRate: '43/hr',
    activities: [{ type: 'clockin', label: 'Clocked In', time: '09:15:00' }],
    checkpoints: [
      {
        name: 'Main Lobby',
        site: 'AIG Solutions HQ',
        time: '11:00:00',
        note: 'Visitor log checked',
      },
    ],
  },
];
...
export default function DailyMonitoring({ language }) {
  ...
  const stats = [
    ...
    {
      label: 'On Shift',
      value: guards.filter((g) => g.status === 'On Shift').length,
      icon: (
        <svg
          width="22"
          height="22"
    ...
    {
      label: 'Late',
      value: guards.filter((g) => g.status === 'Late').length,
      icon: (
        <svg
          width="22"
          height="22"
    ...
    {
      label: 'Absent',
      value: guards.filter((g) => g.status === 'Absent').length,
      icon: (
        <svg
          width="22"
          height="22"
          ...
          <div className="dm-right">
            <div className="dm-detail-header">
              ...
              <div className="dm-detail-info">
                ...
                <p className="dm-detail-meta">
                  <IconLocation /> {selected.site} &nbsp;·&nbsp; <IconCalendar /> {selected.date}{' '}
                  &nbsp;·&nbsp; <IconMoney /> {selected.payRate}
                </p>
              </div>
              <button className="dm-contact-btn">
                <IconPhone /> Contact
              </button>
            </div>
            ...
            <div className="dm-section">
              <div className="dm-section-header">
                ...
                <span className="dm-section-count">
                  ...
                  {selected.activities.length === 1 ? 'event' : 'events'}
                </span>
              </div>
                    ...
                    return (
                      <div key={i} className="dm-activity-row">
                        ...
                        <div className="dm-activity-body">
                          <span className="dm-activity-label" style={{ color: cfg.color }}>
                            {a.label}
                          </span>
            ...
            <div className="dm-section">
              ...
              <p className="dm-section-sub">
                Checkpoint entries, notes and timestamps logged in the field
              </p>
              {selected.checkpoints.length > 0 ? (
                selected.checkpoints.map((cp, i) => (
                  <div key={i} className={`dm-checkpoint ${cp.issue ? 'dm-checkpoint-issue' : ''}`}>
                    <div className="dm-checkpoint-header">
                      <span className="dm-checkpoint-check">
                        {cp.issue ? (
                          <svg
                            ...
                            strokeLinejoin="round"
                          >
                            <circle cx="12" cy="12" r="10" fill="#4a3b12" stroke="#b8860b" />
                            <line x1="12" y1="8" x2="12" y2="12" stroke="#f4c95d" />
                            <circle cx="12" cy="16" r="0.5" fill="#f4c95d" stroke="#f4c95d" />
                          </svg>
                        ) : (
                          <svg
                            width="18"
                      ...
                      <span className="dm-checkpoint-time">
                        <IconClock /> {cp.time}
                      </span>
                    </div>
