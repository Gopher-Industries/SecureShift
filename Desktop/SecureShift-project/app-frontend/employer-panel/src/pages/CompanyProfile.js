...
export default function CompanyProfile({ language }) {
  ...
  const {
    ...
    defaultValues: {
      ...
      tel: '0400 000 000',
      desc:
        'ABC Security has been a leader in retail security since 1990. We work with retailers or facility management, to tailor what we offer, to better meet the needs of the client.',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <PageHeader
        companyName={t.companyNameTitle}
  ...
  return (
    <>
      <div style={headerStyles}>
        ...
        <img
          src={ABC_COMPANY_ICON}
          alt="abc_company_icon"
          style={{ width: '80px' }}
        />
      </div>
