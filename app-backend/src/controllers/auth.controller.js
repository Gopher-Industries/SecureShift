...
export const submitEOI = async (eoiData) => {
  // EOI is persisted as "pending" (schema default). No Employer/User account
  // is created and no credentials are sent until an approval workflow
  // exists — that workflow is out of scope for this ticket (BE 042).
